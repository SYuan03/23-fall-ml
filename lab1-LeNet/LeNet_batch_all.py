...
class MyNet(nn.Module):
    def __init__(self):
        ...
        # out_channels指明了输出的通道数，我们将从中提取6个特征
        ...
        # 卷积层2
        # 这里的输入通道数是6，因为上一层的输出是6个特征图
        # 输出通道数是16，我们将从中提取16个特征
        self.conv2 = nn.Conv2d(6, 16, 5)

        # 池化层2
        # 其实这里的池化层和上面的池化层1是一样的
        # 经过该层后，每张图片对应 16 * 5 * 5 个特征， 16个特征，每个特征大小为5*5
        self.pool2 = nn.MaxPool2d(2, 2)

        # 全连接层1
        # 这里的输入是16*5*5，因为上一层的输出是16个特征图，每个特征图的大小是5x5
